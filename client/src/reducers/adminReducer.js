...
export const adminOrderDeliveredReducer = (state={order:{}},action)=>{
    switch(action.type){
        case ADMIN_ORDER_DELIVERED_REQUEST:
            return {loading:true}
        case ADMIN_ORDER_DELIVERED_SUCCESS:
            return {loading:false,successDelivery:true,order:action.load};
